...
def build_extra(
    ...
    *,
    ...
    # How hard the integration is working, which is what tells you whether the
    # defaults are right on hardware nobody has tested.
    metrics = {
    ...
    if version is not None:
        payload["firmwares"] = {"control": str(version)}
