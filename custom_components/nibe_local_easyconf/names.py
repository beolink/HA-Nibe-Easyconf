...
SHORT_NAMES: dict[str, tuple[str, str]] = {
    ...
    # Titles as the F-series maps have them; the same register carries the
    # same title on every F-series model.
    "BT1 Outdoor Temperature": ("Utetemperatur", "Outdoor temperature"),
    "BT1 Average": ("Utetemperatur, medel", "Outdoor average"),
    "BT2 Supply temp S1": ("Framledning", "Supply line"),
    "EB100-EP14-BT3 Return temp": ("Returledning", "Return line"),
    "BT7 HW Top": ("Varmvatten, topp", "Hot water top"),
    "BT6 HW Load": ("Varmvatten, laddning", "Hot water charging"),
    "EB100-EP14-BT10 Brine In Temp": ("Köldbärare in", "Brine in"),
    "EB100-EP14-BT11 Brine Out Temp": ("Köldbärare ut", "Brine out"),
    "EB100-EP14-BT12 Condensor Out": ("Kondensor ut", "Condenser out"),
    "EB100-EP14-BT14 Hot Gas Temp": ("Hetgas", "Hot gas"),
    "EB100-EP14-BT15 Liquid Line": ("Vätskeledning", "Liquid line"),
    "EB100-EP14-BT17 Suction": ("Suggas", "Suction gas"),
    "BT50 Room Temp S1": ("Rumstemperatur", "Room temperature"),
    "EQ1-BT64 Cool Supply Temp": ("Kyla, framledning", "Cooling supply"),
    "BT25 Ext. Supply": ("Extern framledning", "External supply"),
    "Calc. Supply S1": ("Beräknad framledning", "Calculated supply"),
    "BF1 EP14 Flow": ("Flöde", "Flow"),
    "EB100-BE1 Current": ("Ström fas 1", "Current L1"),
    "EB100-BE2 Current": ("Ström fas 2", "Current L2"),
    "EB100-BE3 Current": ("Ström fas 3", "Current L3"),
    ...
    "Compressor State EP14": ("Kompressorstatus", "Compressor state"),
    "Compressor starts EB100-EP14": ("Kompressorstarter", "Compressor starts"),
    "Tot. op.time compr. EB100-EP14": ("Drifttid kompressor", "Compressor run time"),
    "Tot. HW op.time compr. EB100-EP14": ("Drifttid, varmvatten", "Run time, hot water"),
    "compr. in power": ("Kompressoreffekt", "Compressor power"),
    "Supply Pump Speed EP14": ("VB-pump, varvtal", "HM pump speed"),
    "EP14-GP2 Brine Pump Status EP14": ("KB-pump, varvtal", "Brine pump speed"),
    ...
    "preset flow clim. sys.": ("Inställt flöde", "Preset flow"),
    "Heat Medium Flow dT Actual": ("VB-flöde, dT nu", "Flow dT, actual"),
    "Heat Medium Flow dT Set Point": ("VB-flöde, dT börvärde", "Flow dT, set point"),
    ...
    "Heat Curve S1": ("Värmekurva", "Heating curve"),
    "Heat Offset S1": ("Kurvförskjutning", "Curve offset"),
    "Hot water comfort mode": ("Varmvattenläge", "Hot water mode"),
    "Temporary Lux": ("Tillfällig lyx", "Temporary lux"),
    "Operational mode": ("Driftläge", "Operating mode"),
    "Max int add. power": ("Elpatron, max", "Immersion max"),
    "Allow Additive Heating": ("Tillåt tillsats", "Allow add. heat"),
    "Allow Heating": ("Tillåt värme", "Allow heating"),
    "Holiday - Activated": ("Semesterläge", "Holiday mode"),
    "MODBUS40 Disable LOG.SET": ("LOG.SET-fil", "LOG.SET file"),
    "Modbus40 Word Swap": ("Ordföljd, 32 bitar", "32-bit word swap"),
}
